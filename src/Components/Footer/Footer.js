...
function Footer() {
    return (
        <div className="bg-background fixed grid grid-cols-10 bottom-0 w-full 2xl:text-md xl:text-sm text-xs opacity-80">
            <div className="items-center justify-self-start md:col-span-7 col-span-9 flex mx-4 md:mx-16 h-8 2xl:h-12">
            ...
            <a
                className="items-center md:col-span-3 col-span-1 flex justify-self-end mx-4 md:mx-16"
                href="#Home"
            >
